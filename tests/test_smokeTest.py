...
class TestSmokeTest():
  ...
  def test_directory(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(516, 691)
    self.driver.find_element(By.CSS_SELECTOR, "#hamburger-equiv > img").click()
  ...
  def test_home(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1253, 691)
  ...
  def test_home2(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1240, 691)
  ...
  def test_join(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Soriano")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("BYU")
